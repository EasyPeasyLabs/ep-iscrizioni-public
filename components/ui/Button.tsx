...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "border-transparent text-white bg-brand-blue hover:bg-blue-900 focus:ring-brand-blue",
    secondary: "border-transparent text-brand-blue bg-brand-yellow hover:bg-yellow-400 focus:ring-brand-yellow",
    outline: "border-brand-blue text-brand-blue bg-white hover:bg-blue-50 focus:ring-brand-blue",
